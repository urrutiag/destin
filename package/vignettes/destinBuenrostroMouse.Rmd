...
- blacklistFile is the path to file containing peaks to exclude: either wgEncodeDacMapabilityConsensusExcludable.bed.gz (mouse) or ENCFF001TDO.bed.gz (human)
...
## 3.4. (optional) Append experimental information 
