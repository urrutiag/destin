...
input: indexed bam files (one bam per cell), peaks file  
output: ranged summarized experiment
```{r eval=FALSE}
...
colData now contains additional experimental data
```{r eval=FALSE}
colData(rse)[1,]
```
