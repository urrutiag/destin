...
if you have already installed the github repository, you can install the R package from the local copy.  yourPathToDestinRepo is your path to the local cloned repository
