...
We search a space of 1 to 20 number of clusters (user-modifiable). Here we find 5 clusters.  Note that search space must begin with 1.
...
```{r}
clusterEst = list()
clusterEst$nClustersEstimate = 5
```
