...
sampleName = "PreisslP56"
outDir = "~/Documents/gitRepos/destin/practice/PreisslP56"
cellDataFile = file.path(outDir, "cellDataPreissl.txt")
model = "mm10"
```
...
## 3.5. (optional) Append experimental information if available
```{r eval=FALSE}
...
The output includes a genetic feature, Bonferroni corrected p-value and log2 fold change for each chromatin accessible region.
