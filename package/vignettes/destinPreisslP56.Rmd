...
For this example we begin at this step 3.1. but skip 3.3 through 3.5 for due to large file sizes.  Previous steps are described for reference.
...
```{r}
table(results$cluster$cluster, rse$cell_type)
```
